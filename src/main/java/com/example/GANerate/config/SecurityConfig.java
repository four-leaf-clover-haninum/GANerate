...
//                .addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class)
                ...
                .antMatchers("/v1/subscribe","/v1/users/sign-up", "/v1/users/sign-in", "/v1/users/email", "/v1/users/email/verify", "/v1/users/reissue", "/v1/users/logout", "/v1/main/**", "/docs/**", "/", "/health", "/payment" ).permitAll()
