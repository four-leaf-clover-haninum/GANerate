                ...
                .andDo(
                        restDocs.document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("data.categoryNames").type(JsonFieldType.ARRAY).description("카테고리 명 리스트"),
                                        fieldWithPath("data.categoryIds").type(JsonFieldType.ARRAY).description("카테고리 아이디 리스트"),
